...
public class ComplexSymbolFactory implements SymbolFactory {
     ...
     */
    public static class ComplexSymbol extends java_cup.runtime.Symbol {
        ...
        public ComplexSymbol(String name, int id, java_cup.runtime.Symbol left, java_cup.runtime.Symbol right) {
            super(id,left,right);
            this.name=name;
        ...
        public ComplexSymbol(String name, int id, java_cup.runtime.Symbol left, java_cup.runtime.Symbol right, Object value) {
            super(id,value);
            this.name=name;
            if (left!=null)  this.xleft = ((ComplexSymbol)left).xleft;
            if (right!=null) this.xright= ((ComplexSymbol)right).xright;
    ...
    // Factory methods
    public java_cup.runtime.Symbol newSymbol(String name, int id, Location left, Location right, Object value){
        return new ComplexSymbol(name,id,left,right,value);
    }
    public java_cup.runtime.Symbol newSymbol(String name, int id, Location left, Location right){
